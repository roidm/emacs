;;; doom-catppuccin-theme.el --- inspired by VS code's catppuccin -*- lexical-binding: t; no-byte-compile: t; -*-
;;
;; Added: August 12, 2019 (741defec2c08)
;; Author: Brettm12345 <https://github.com/Brettm12345>
;; Maintainer:
;; Source: https://github.com/atomiks/catppuccin-vscode-theme
;;
;;; Commentary:
;;; Code:
...
(def-doom-theme doom-catppuccin
    "A dark theme inspired by VS code's catppuccin"

  ;; name        default   256       16
  ((bg         '("#11111b" "#11111b"  "black"))
   (bg-alt     '("#181825" "#181825" "black"))
   (base0      '("#1e1e2e" "#1e1e2e" "black"))
   (base1      '("#181825" "#181825" "brightblack"))
   ...
   (base8      '("#b8c0e0" "#b8c0e0" "white"))
   (indigo     '("#7a88cf" "#7a88cf" "brightblack"))
   (region     '("#383e5c" "#383e5c" "brightblack"))
   (fg         '("#cdd6f4" "#cdd6f4" "brightwhite"))
   (fg-alt     '("#b8c0e0" "#b8c0e0" "white"))

   (grey base5)

   (dark-red      '("#e78284" "#e78284" "red"))
   (red           '("#f38ba8" "#f38ba8" "red"))
   (light-red     '("#ff98a4" "#ff98a4" "brightred"))
   (orange        '("#fab387" "#fab387" "brightred"))
   (green         '("#a6e3a1" "#a6e3a1" "green"))
   (dark-teal     '("#8bd5ca" "#8bd5ca" "green"))
   (teal          '("#94e2d5" "#94e2d5" "brightgreen"))
   (light-teal    '("#81c8be" "#81c8be" "brightgreen"))
   (yellow        '("#f9e2af" "#f9e2af" "brightyellow"))
   (blue          '("#8aadf4" "#8aadf4" "brightblue"))
   (dark-blue     '("#7287fd" "#7287fd" "brightblue"))
   (light-blue    '("#50c4fa" "#50c4fa" "blue"))
   (light-magenta '("#b4befe" "#b4befe" "brightmagenta"))
   (magenta       '("#cba6f7" "#cba6f7" "brightmagenta"))
   (violet        '("#b4befe" "#b4befe" "magenta"))
   (light-pink    '("#f4b8e4" "#f4b8e4" "magenta"))
   (pink          '("#f5c2e7" "#f5c2e7" "magenta"))
  ...
  ((font-lock-keyword-face :foreground keywords)
   ...
   ;;;; doom-modeline
   (doom-modeline-buffer-file       :foreground base7 :bold t)
   (doom-modeline-icon-inactive     :foreground indigo)
   (doom-modeline-evil-normal-state :foreground dark-cyan :bold t)
   (doom-modeline-evil-insert-state :foreground blue :bold t)
   (doom-modeline-project-dir       :foreground light-teal)
   (doom-modeline-buffer-path       :foreground blue :bold t)
